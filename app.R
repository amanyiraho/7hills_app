## problemen met hms functie, alle tijd eerst omrekenen naar seconden, op het laatst pas weer omrekenen naar tijd
...
server <- function(input, output) {
  ...
  output$plot1 <-  renderImage({
    ...
    # df route per loper maken om daarna te vullen met tussenliggende tijden
